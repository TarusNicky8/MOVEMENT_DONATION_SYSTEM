...
$query = @mysql_query("select * from sabbaths where  mobile = '$mobile'  ")or die(mysql_error());
...
mysql_query("insert into sabbaths(fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,thumbnail) 
...
?>
<script>
window.location = "add_sabbathsch.php";
