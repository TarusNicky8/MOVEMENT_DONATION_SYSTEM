...
<div class="block-content collapse in">
  ...
  <option value="Sabbath Service">Sunday Service</option>
  <option value="Morning Studies">Morning Studies</option>
  <option value="Afternoon Studies">Afternoon Studies</option>
