    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_members=mysql_query("select * from sabbaths");
	             $count = mysql_num_rows($count_members);
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"></i><i class="icon-members"></i> Movement Sabbath School(s) List</div>
								<div class="muted pull-right">
								Number of Sabbath School Kids: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_memberss.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$members_query = mysql_query("select * from sabbaths")or die(mysql_error());
