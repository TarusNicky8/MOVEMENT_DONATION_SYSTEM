...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="Movement Manager" />
        <meta name="keywords" content="Movement, Manager, Member registration, Donation, Tithe Manager" />
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>MOVEMENT MANAGER <span>ACCESS POINT</span></h1>
                        ...
                        <div id="register" class="animate form">
                            <form  action="reg.php" method="POST" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input id="usernamesignup" name="fname" required="required" type="text" placeholder="Tess" />
                                </p>
                                <p> 
                                    <label for="usernamesignup" class="uname" data-icon="u" > Middle Name</label>
                                    <input id="usernamesignup" name="sname" required="required" type="text" placeholder="Nick"/> 
                                </p>
								<p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Last Name</label>
                                    <input id="usernamesignup" name="lname" required="required" type="text" placeholder="Lambert" />
                                </p>
								<p> 
  ...
  <option value="non-binary">non-binary</option>
								...
								<p> 
                                    ...
                                    <input id="usernamesignup" name="residence" required="required" type="text" placeholder="Aviation" />
                                </p>
								<p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Place of Birth</label>
                                    <input id="usernamesignup" name="pob" required="required" type="text" placeholder="Nairobi" />
                                </p>
								<p> 
  ...
  <option value="Nethinim">Nethinim</option>
